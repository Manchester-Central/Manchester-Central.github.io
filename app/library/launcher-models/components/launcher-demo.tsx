...
export default function VeloAtHeightDemo() {
	...
	function calculateVectorVelocityAtHeight(current_position: THREE.Vector3,
	...
	var target_obj = makeThickLine(
			...
			"#00ff00");
	var aim_vector = calculateVectorVelocityAtHeight(current_position, target_position, current_velocity);
	...
	useEffect(() => {
		...
		function animate() {
			...
			aim_vector = calculateVectorVelocityAtHeight(current_position, target_position, current_velocity);
